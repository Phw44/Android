...
public class TinyDB {
    ...
    public ArrayList<ItemsPopularModel> getListObject(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ItemsPopularModel> playerList = new ArrayList<ItemsPopularModel>();

        for (String jObjString : objStrings) {
            ItemsPopularModel player = gson.fromJson(jObjString, ItemsPopularModel.class);
    ...
    public void putListObject(String key, ArrayList<ItemsPopularModel> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (ItemsPopularModel player : playerList) {
